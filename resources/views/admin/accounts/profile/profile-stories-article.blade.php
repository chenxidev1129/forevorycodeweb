        ...
        <div class="stories_top">
            ...
            <img src="{{ getUploadMedia($getProfileDetail[0]->image) }}"
                ...
                @if(!empty($getProfileDetail[0]->text))    
                    <a href="{{ route('admin/read-more-stories-article',[$getProfileDetail[0]->id]) }}" class="readMore font-bd theme-link h15">Read More<em class="icon-read-more-right"></em></a>
                 @endif       
            @endif
        </div>
    </div>
                ...
                <li class="media">
                    <div class="media-body">
                        ...
                        @if(!empty($getProfileDetail[$i]->text))
                            <a href="{{ route('admin/read-more-stories-article',[$getProfileDetail[$i]->id]) }}" class="readMore font-bd theme-link h15">Read More<em class="icon-read-more-right"></em></a>
                        @endif        
                    </div>
