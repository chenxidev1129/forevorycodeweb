...
<head>
	...
	<title>Guest book has been signed by a {{$data['profile_user']}} || Forevory</title>
</head>
<body>
	<style type="text/css">
	...
	<table style="width:600px;  margin:50px auto 0; background-color:#ffffff;padding:40px 20px; " cellpadding="0" cellspacing="0">
		...
		<tr>
			<td style="font-size: 16px;color:#7b7777; padding-top:30px; padding-bottom: 30px;">{{ $data['signed_user'] }} has signed the Guest book for profile {{ $data['profile_name'] }}.</td>
		</tr>
		<tr>
			<td>
