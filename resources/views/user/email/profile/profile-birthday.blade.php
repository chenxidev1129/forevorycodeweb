...
<head>
	...
	<title>Today is {{$data['profile_user']}}'s birthday || Forevory</title>
</head>
<body>
	<style type="text/css">
	...
	<table style="width:600px;  margin:50px auto 0; background-color:#ffffff;padding:40px 20px; " cellpadding="0" cellspacing="0">
		...
		<tr>
			<td style="font-size: 16px;color:#7b7777; padding-top:30px; padding-bottom: 10px;">Today is {{ $data['profile_name'] }}'s birthday.</td>
		</tr>
		<tr>
			<td style="font-size: 16px;color:#7b7777; padding-top:30px; padding-bottom: 20px;">May the angels sing {{ $data['profile_name'] }} the most joyous chores of Happy Birthday today.</td>
		</tr>
		<tr>
			<td>
