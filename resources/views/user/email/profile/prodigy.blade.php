...
<body>
	...
	<table style="width:600px;  margin:50px auto 0; background-color:#ffffff;padding:40px 20px; " cellpadding="0" cellspacing="0">
		...
		<tr>
			<td style="font-size: 16px;color:#7b7777; padding-top:30px; padding-bottom: 10px;">We have sent the QR code to your address. We will keep you posted on further updates. For more info, please reach out to <a href="mailto:info@forevory.com" style="color:#35BDF3; font-size: 14px;">info@forevory.com.</a></td>
		</tr>
		<tr>
			<td>
