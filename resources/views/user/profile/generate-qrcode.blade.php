...
<a href="{{ url('downlaod-qrcode/'.$result->id) }}" download="" target="_blank" class="btn btn-sm btn-primary d-flex ripple-effect">Download</a>
...
<ul class="list-inline">
    ...
    <li class="list-inline-item position-relative share">
        ...
        <div class="socialMedia row no-gutters">
            ...
            <div class="col-6">
                <a href="{{ Share::load( $result->shared_link, $result->profile_name, getUploadMedia($result->qrcode_image))->twitter() }}" class="twitter ripple-effect" target="_blank"><em class="icon-twitter"></em></a>
            </div>
            <div class="col-6">
